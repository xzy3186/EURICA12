...
int main(int argc, char* argv[]){
   ...
   sprintf(dssdfile,"../root/sistopper/sn136test/WASABI_EURICA%04d.root",runN);
   ...
   sprintf(bigripsfile,"../root/bigrips/v2/RIBF85.root");
   //sprintf(outfile,"../root/sistopper/beta_ion_%04d.root",runN);
   sprintf(outfile,"../root/final/sn136test/beta_ion_%04d.root",runN);
