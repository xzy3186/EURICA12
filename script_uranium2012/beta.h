...
class beta {
   public :
      ...
      Int_t           dssd_X0;//not necessary dssd0 but the first fired dssd
      Int_t           dssd_Y0;//not necessary dssd0 but the first fired dssd
      Int_t           dssd_X7;//not necessary dssd7 but the last fired dssd
      Int_t           dssd_Y7;//not necessary dssd7 but the last fired dssd
      Int_t           dssd_E;
      ...
      virtual void     GetTsEntry(multimap <Long64_t, pair<pair<Long64_t, Int_t>, pair<Int_t, Int_t> > > &mts);
...
void beta::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("dssd_X0", &dssd_X0, &b_dssd_X0);
   fChain->SetBranchAddress("dssd_Y0", &dssd_Y0, &b_dssd_Y0);
   fChain->SetBranchAddress("dssd_X7", &dssd_X7, &b_dssd_X7);
   fChain->SetBranchAddress("dssd_Y7", &dssd_Y7, &b_dssd_Y7);
...
void beta::GetTsEntry(multimap <Long64_t, pair<pair<Long64_t, Int_t>, pair<Int_t, Int_t> > > &mts){
   ...
   for(Long64_t jentries=0; jentries<nentries; jentries++){
      ...
      nbytes+=nb;
      mts.insert(make_pair(ts, make_pair(make_pair(jentries,z), make_pair(x,y) ) ) );
   }
}
...
void beta::TreeBranch(TTree *tree){
   ...
   tree->Branch("dssd_X0",&dssd_X0,"dssd_X0/I");
   tree->Branch("dssd_Y0",&dssd_Y0,"dssd_Y0/I");
   tree->Branch("dssd_X7",&dssd_X7,"dssd_X7/I");
   tree->Branch("dssd_Y7",&dssd_Y7,"dssd_Y7/I");
