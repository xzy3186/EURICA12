...
int main(int argc, char* argv[]){
   ...
   sprintf(dssdfile,"../root/sistopper/rh123test/WASABI_EURICA%04d.root",runN);
   ...
   sprintf(bigripsfile,"../root/bigrips/v2/RIBF60-124Rh.root");
   //sprintf(outfile,"../root/sistopper/beta_ion_%04d.root",runN);
   sprintf(outfile,"../root/final/rh123test/beta_ion_%04d.root",runN);
