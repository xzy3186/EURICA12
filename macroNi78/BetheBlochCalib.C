...
void BetheBlochCalib(char* filename) {
  int zedmin = 27, zedmax = 32;
  double betamin = 0.62, betamax = 0.66;
  double deltaEmin = 180, deltaEmax = 320;
  //  double d_zed = 0.4; //for zed gate
  TString flag = "&&flagall==1";
  char filenameout[] = "macroNi78/parameters/zedcalib/zedcalib5prm.txt";
  double betashift = 0.0035; // typical value of betaIC - beta57, here this is assumed to be constant. 
