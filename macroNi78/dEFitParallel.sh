...
myfun()
{
    batchname=$dir'macro/dEFit.C("'$dir'treework/PIDJan25.root",'$1')'
...
#list=`echo {1000..1000}`
list=`echo {1000..1057}`
list=$list' '`echo {1061..1169}`
echo $list

dir='/home/sumikama/Analysis/Ni78/'
filenameout1=$dir'parameters/zedcalib/dERawprm.txt'
rm $filenameout1

(mapp myfun $list)

sort -o $filenameout1 $filenameout1
