...
const int nlist = 5; // array size of zlist & alist
void dEcalib(const char* filein, int runnumber) {
  ...
  char* fileoutdECoef = "macroNi78/parameters/zedcalib/dECoef.txt";
  char* fileoutzedCoef = "macroNi78/parameters/zedcalib/zedcalibCalc.txt"; 

  int zlist[nlist] = {28,28,29,29,30};
  int alist[nlist] = {74,75,77,78,81};
  double zoffset=0.2, aoqoffset=0;
  double dzed = 0.4, daoq = 0.005;//width used in PID gate
  double Brho57 = 7.0675; // Brho value of central trajectory
