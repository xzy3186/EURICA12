...
int main(int argc, char* argv[]){
   ...
   sprintf(dssdfile,"../root/sistopper/cu81test/beta_ion_%04d.root",runD);
   sprintf(outfile,"../root/sistopper/cu81test/decay_new%04d.root",runD);
   ...
   for(imtsi=mtsi.begin(); imtsi!=mtsi.end(); imtsi++){
      ...
      tcbeta.Clear();
      Long64_t ts2 = imtsi->first + time_window;
      int decay_index=0;
      current_time = 0;
      bEntry_best = 0;
      deltaz_min=2;
