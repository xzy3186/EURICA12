...
int main(int argc, char* argv[]){
   ...
   sprintf(dssdfile,"../root/sistopper/pd128test/WASABI_EURICA%04d.root",runN);
   ...
   sprintf(bigripsfile,"../root/bigrips/v2/RIBF60-128Pd.root");
   //sprintf(outfile,"../root/sistopper/beta_ion_%04d.root",runN);
   sprintf(outfile,"../root/final/pd128test/beta_ion_%04d.root",runN);
