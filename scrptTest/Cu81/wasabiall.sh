...
{
(
    cd /home/analysis/ribf_exp/ur12/users/xuzy/script_81cu
...
echo $list
#anarootlogin
source /home/analysis/ribf_exp/ur12/anaroot/scripts/anarootlogin.sh xuzy >> /dev/null
