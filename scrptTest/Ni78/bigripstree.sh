...
myfun()
{
    filenamein='/home/ur12/rawdata/bigrips/RIBF10/RIBF10-'
    filenamein=$filenamein$1'.ridf'
    filenameout='/home/ur12/treefiles/bigrips/v0/bigrips_run'
    filenameout=$filenameout$1'.root'
    batchname='/home/ur12/analysis/users/isobe/MakeFullBigRIPSTree.C("'$filenamein'","'$filenameout'")'
    root -b -q $batchname >> /dev/null
    echo $1' was finished.'
}

for eachrun in {1170..1170}
do
    list=$list' '$eachrun
done
