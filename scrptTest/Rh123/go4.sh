...
(
	...
	go4analysis -lib /raid/01/home/ur12/analysis/users/xuzy/go4_${1}/libGo4UserAnalysis.so -disable-asf -file /raid/01/home/ur12/analysis/users/xuzy/rawdata/euroball/rh123data/run_${1}.lmd >> /dev/null
