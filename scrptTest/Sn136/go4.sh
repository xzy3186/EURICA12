...
(
	...
	go4analysis -lib /raid/01/home/ur12/analysis/users/xuzy/go4/libGo4UserAnalysis.so -disable-asf -file /raid/01/home/ur12/analysis/users/xuzy/go4/lmdfiles/sn136data/run_${1}.lmd 
	mv -f go4.root ~/treefiles/euroball/go4_${1}.root
    echo 'Go4 analysis ' $1 ' finished'
)
}

for eachrun in {3120..3121}
do
    list=$list' '$eachrun
done
