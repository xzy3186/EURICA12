...
myfun()
{
    filenamein='/home/ur12/rawdata/bigrips/uranium2012/RIBF85-'
    filenamein=$filenamein$1'.ridf'
    filenameout='/home/ur12/treefiles/bigrips/v0.nocorr/bigrips_run'
    filenameout=$filenameout$1'.root'
    batchname='/home/ur12/analysis/users/sumikama/MakeFullBigRIPSTreeSn136.C("'$filenamein'","'$filenameout'")'
    root -b -q $batchname >> /dev/null
    echo $1' was finished.'
}

for eachrun in {4000..4000}
do
    list=$list' '$eachrun
done
