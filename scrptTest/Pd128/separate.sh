...
{
(
#this process require WASABI_EURICA.root and bigrips_run.root
#and generate beta_ion.root
    cd /home/ur12/analysis/users/xuzy/script_128pd
    ./separate $1 $1 >> /dev/null
    echo $1' was finished.'
)
}

for eachrun in {2077..2080}
do
    list=$list' '$eachrun
done
